            ...
            return (
              <li key={to} className="flex-1">
                ...
                >
                  ...
                  <Icon
                    className={`relative z-10 h-5 w-5 transition-colors ${active ? "text-primary-foreground" : "text-muted-foreground group-hover:text-primary"}`}
                    strokeWidth={active ? 2.5 : 2}
                  />
                  <span
                    className={`relative z-10 text-[10px] font-medium transition-colors ${active ? "text-primary-foreground" : "text-muted-foreground group-hover:text-primary"}`}
                  >
                    {label}
                  </span>
                </Link>
